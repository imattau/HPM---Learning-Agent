...
Provides:
  - make_orchestrator(): construct N agents sharing a store + field + monitor
...
def make_orchestrator(
    ...
    **overrides,
    ...
    All agents share the same store so the StructuralLawMonitor can observe
    the full population across agents. Each agent is namespaced by agent_id.
    ...
    monitor = StructuralLawMonitor(store, T_monitor=T_monitor) if with_monitor else None
